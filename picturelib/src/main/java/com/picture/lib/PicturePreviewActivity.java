...
import com.picture.lib.adapter.SimpleFragmentAdapter;
import com.picture.lib.anim.OptAnimationLoader;
...
import com.picture.lib.tools.VoiceUtils;
import com.picture.lib.widget.PreviewViewPager;
...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv_ok.setText(numComplete ? getString(R.string.picture_preview_num,
    ...
    public void onSelectNumChange(boolean isRefresh) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                tv_ok.setText(getString(R.string.picture_preview_num, selectImages.size(),
            ...
            if (numComplete) {
                tv_ok.setText(getString(R.string.picture_preview_num, 0,
                        config.selectionMode == PictureConfig.SINGLE ? 1 : config.maxSelectNum));
            } else {

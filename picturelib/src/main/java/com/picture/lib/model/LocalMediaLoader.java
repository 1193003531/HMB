                            ...
                            if (data != null) {
                                ...
                                if (count > 0) {
                                    ...
                                    if (latelyImages.size() > 0) {
                                        ...
                                        if (type == PictureMimeType.ofAudio()) {
                                            allImageFolder.setName(activity.getString(R.string.picture_all_audio));
                                        } else if (type == PictureMimeType.ofVideo()) {
                                            allImageFolder.setName(activity.getString(R.string.picture_all_video));
                                        } else {

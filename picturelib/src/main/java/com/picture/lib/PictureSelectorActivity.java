...
import com.picture.lib.adapter.PictureAlbumDirectoryAdapter;
import com.picture.lib.adapter.PictureImageGridAdapter;
...
import com.picture.lib.dialog.CustomDialog;
import com.picture.lib.entity.EventEntity;
import com.picture.lib.entity.LocalMedia;
import com.picture.lib.entity.LocalMediaFolder;
import com.picture.lib.model.LocalMediaLoader;
import com.picture.lib.observable.ImagesObservable;
import com.picture.lib.permissions.RxPermissions;
import com.picture.lib.rxbus2.RxBus;
import com.picture.lib.rxbus2.Subscribe;
import com.picture.lib.rxbus2.ThreadMode;
import com.picture.lib.tools.DateUtils;
...
import com.picture.lib.tools.StringUtils;
import com.picture.lib.tools.ToastManage;
import com.picture.lib.widget.FolderPopWindow;
import com.picture.lib.widget.PhotoPopupWindow;
import com.ucrop.lib.UCrop;
import com.ucrop.lib.UCropMulti;
import com.ucrop.lib.model.CutInfo;
...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        if (config.mimeType == PictureMimeType.ofAudio()) {
            picture_title.setText(getString(R.string.picture_all_audio));
        } else if (config.mimeType == PictureMimeType.ofVideo()) {
            picture_title.setText(getString(R.string.picture_all_video));
        } else {
...
//                : getString(R.string.picture_camera_roll);
    ...
    private void isNumComplete(boolean numComplete) {
        //picture_tv_ok
        picture_id_preview.setText(numComplete ? getString(R.string.picture_preview,
    ...
    @Override
    public void onSingleChange(LocalMedia media) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                ...
                picture_id_preview.setText(getString
                        (R.string.picture_preview, selectImages.size(),
            ...
            if (numComplete) {
                //picture_tv_ok picture_done_front_num
                picture_tv_ok.setText(getString((R.string.picture_please_select)));
                picture_id_preview.setText(getString(R.string.picture_preview, 0,
                        config.selectionMode == PictureConfig.SINGLE ? 1 : config.maxSelectNum));
            } else {

...
public class XRegexUtils {
     ...
     * @return 星号替换的银行卡号
     */
    public static String cardIdHide2(String cardId) {
        String card = cardId.substring(0, 4) + " **** **** " + cardId.substring(cardId.length() - 4, cardId.length());
        return card;
    }
    ...
    public static String cardIdHide(String cardId) {
        return cardId.replaceAll("\\d{14}(\\d{4})", "**** **** **** ** $1");
    }
    ...
    public static boolean checkMobile(String mobile) {
        // 第2位：{3、4、5、6、7、89}任意数字；
        String telRegex = "^1[3|4|5|6|7|8|9][0-9]\\d{8}$";

        //String telRegex = "^((13[0-9])|(14[0-9])|(15[0-9])|(18[0-9])|(17[0-9])|(19[0-9]))\\d{8}$";
        if (XEmptyUtils.isEmpty(mobile))
            return false;
        else
            return Pattern.matches(telRegex, mobile);
    }

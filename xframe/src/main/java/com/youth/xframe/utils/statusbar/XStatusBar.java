...
public class XStatusBar {
    public static final int DEFAULT_STATUS_BAR_ALPHA = 80;
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.xstatusbar_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.xstatusbar_translucent_view;

package com.huimaibao.app.appload;
...
public class AppDownloadManager {
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        File apkFile = new File(weakReference.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "汇脉宝.apk");
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, "汇脉宝.apk");
    ...
    private void updateView() {
        ...
        //XLog.i(TAG, "下载进度：" + bytesAndStatus[0] + "/" + bytesAndStatus[1] + "");
    }
        ...
        if (downloadId != -1) {
            ...
            if (cur != null) {
                if (cur.moveToFirst()) {
                    ...
                    if (!XEmptyUtils.isEmpty(uriString)) {

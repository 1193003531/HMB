...
public class PayPsdInputView extends AppCompatEditText {
     ...
     * 圆的颜色   默认BLACK
     */
    private int circleColor = getResources().getColor(R.color.color000000);
    /**
     * 底部线的颜色   默认GRAY
     */
    private int bottomLineColor = getResources().getColor(R.color.d8d8d8);

    /**
     * 分割线的颜色
     */
    private int borderColor = getResources().getColor(R.color.d8d8d8);
    /**
     * 分割线的画笔
     */
     ...
     * 竖直分割线的颜色
     */
    private int divideLineColor = getResources().getColor(R.color.d8d8d8);
    private int focusedColor = getResources().getColor(R.color.FF274FF3);
...
//         height);
//          canvas.drawRoundRect(focusedRecF, 0, 0, getPaint(3, Paint.Style.STROKE, focusedColor));

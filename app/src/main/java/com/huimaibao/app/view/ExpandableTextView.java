...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            //mExpandDrawable = ContextCompat.getDrawable(getContext(),R.drawable.ic_arrow_back);
        }
        if (mCollapseDrawable == null) {
            // mCollapseDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_arrow_back);
        }
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.color000000));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, XDensityUtils.sp2px(15));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.color000000));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, XDensityUtils.sp2px(15));

...
public class ChannelItem implements Serializable {
    ...
    public ChannelItem(int pid, int id, String name, int orderId, int selected) {
    ...
    public void setPId(int paramInt) {
        this.pid = Integer.valueOf(paramInt);
    }
    ...
    public String toString() {
        return "MakingListEntity [id=" + this.id + ", name=" + this.name

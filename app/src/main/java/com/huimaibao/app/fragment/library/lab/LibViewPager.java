package com.huimaibao.app.fragment.library.lab;
...
public class LibViewPager extends ViewPager {
    ...
    public LibViewPager(@NonNull Context context) {
        super(context);
        init(context);
    }


    public LibViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

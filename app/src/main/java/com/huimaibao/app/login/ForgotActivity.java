...
public class ForgotActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_login_forgot);
            ...
            public void run() {
                LoginLogic.Instance(mActivity).LoginSendSMSApi(phone, type, new ResultBack() {
                    ...
                    public void onSuccess(Object object) {
                        ...
                        startActivity(VerificationCodeActivity.class, "忘记密码");
                        finish();
                    }
                        ...
                        if (status.equals("0")) {
                            ...
                            if (dataJ.getBoolean("is_exist")) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        mDialogUtils.showNoTitleDialog("您的手机号不存在,去注册", "取消", "注册", new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                                startActivity(RegisterActivity.class, "注册");
                                                finish();

package com.huimaibao.app.zxing.act;
...
import com.huimaibao.app.zxing.camera.CameraManager;
import com.huimaibao.app.zxing.decoding.CaptureActivityHandler;
import com.huimaibao.app.zxing.decoding.InactivityTimer;
import com.huimaibao.app.zxing.decoding.RGBLuminanceSource;
import com.huimaibao.app.zxing.util.Constant;
import com.huimaibao.app.zxing.util.UriUtil;
import com.huimaibao.app.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_zxing_scanner);
        setNeedBackGesture(true);
        setTopTitle("扫一扫");
        setTopLeft(true, true, false, "");
        setTopRight(false, true, false, "", null);

        View _needOffsetView = findViewById(R.id.fake_status_bar);
        XStatusBar.setTranslucentForImageViewInFragment(this, 50, _needOffsetView);

        CameraManager.init(getApplication());
        viewfinderView = findViewById(R.id.viewfinder_content);
        back = findViewById(R.id.iv_title_left);
